(function($) {
    $.fn.upload = function(look_call_back){
        ...
        config = {
            ...
            type : _this.attr('data-type') ? _this.attr('data-type') : 'png,jpg,jpeg,gif,xlsx,xls',
            upname : _this.attr("data-file") ? _this.attr("data-file") : 'excel',
                            ...
                            success:function(data){
                                try {
                                    ...
                                    if(data.code)
                                    {
                                        ...
                                        if (data.data && data.data.excel && data.data.excel[0])
                                        {
                                        ...
                                        item.addClass("error").attr("data-error",errMsg);
                                    } else {
                                        var downloadPath = data.data.filePath;
                                    ...
                                    var downloadPath = data.data.filePath;
                                    window.location.href = downloadPath;
                                    // item.addClass("success").attr("data-error","Excel文件上传成功");
                                }
                            },
                            xhr:function(){
